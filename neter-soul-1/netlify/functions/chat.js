...
{"retrato":{"paisagem_interna":"MÍNIMO 3 frases, visão macro narrativa do momento de vida, ancorada no que a pessoa revelou, linguagem simples e acolhedora"},"mapa":{"pilares":"MÍNIMO 3 frases sobre pontos de força reais que apareceram nas respostas","sombras":"MÍNIMO 3 frases sobre vulnerabilidades e bloqueios que apareceram nas respostas"},"dinamicas":{"padrao_central":"MÍNIMO 3 frases sobre o padrão que mais se repete, ancorado nas respostas","lealdade_invisivel":"MÍNIMO 3 frases sobre a lealdade familiar que prende"},"hellinger":{"padrao_sistemico":"MÍNIMO 3 frases: repetições da família, pertencimento, ordem, quem pode estar excluído — ancorado no que a pessoa contou da sua história familiar","hipotese":"MÍNIMO 3 frases sobre a raiz familiar provável"},"feridas":{"primaria":"Rejeição|Abandono|Humilhação|Traição|Injustiça","primaria_descricao":"MÍNIMO 3 frases sobre como essa ferida aparece no dia a dia da pessoa, ancorado nas respostas","mascara":"nome simples da máscara de proteção","crenca_nuclear":"a crença limitante na 1ª pessoa entre aspas"},"jung":{"arquetipo_dominante":"nome simples do arquétipo","sombra":"MÍNIMO 3 frases sobre o que foi escondido ou negado, ancorado nas respostas","individuacao":"MÍNIMO 3 frases sobre o caminho de crescimento"},"eneagrama":{"tipo_provavel":"número 1-9","tipo_nome":"nome do tipo","medo_nuclear":"MÍNIMO 3 frases sobre o medo profundo e como reage sob estresse, ancorado nas respostas"},"impactos":{"texto":"MÍNIMO 3 frases sobre como esses padrões afetam relacionamentos, trabalho, autoestima, decisões e autocobrança"},"recomendacoes":{"mov1":{"titulo":"título curto","texto":"MÍNIMO 3 frases com orientação prática"},"mov2":{"titulo":"título curto","texto":"MÍNIMO 3 frases, incluir tema para levar à Anna Goldi"}},"sintese":{"no_central":"MÍNIMO 3 frases: a SÍNTESE GERAL que costura as 5 lentes num fio único, mostrando como sistêmico, sombra, ferida, recurso e eneatipo se conectam nesta pessoa específica","recurso_oculto":"MÍNIMO 2 frases sobre força genuína","foco_terapeutico":"MÍNIMO 3 frases sobre o próximo passo"},"sintese_clinica":{"pontos_fortes":"MÍNIMO 2 frases: talentos e recursos internos que apareceram nas respostas","pontos_frageis":"MÍNIMO 2 frases: maiores dores e máscaras de defesa","pontos_atencao":"MÍNIMO 2 frases: sinais de alerta e cuidados, de forma acolhedora e não alarmista","padroes_sistemicos":"MÍNIMO 2 frases: repetições familiares e lealdades invisíveis","crencas_limitantes":"MÍNIMO 2 frases: ideias fixas que bloqueiam o fluxo da vida"},"perfil_dor":"uma frase longa, humana e precisa que captura a essência da dor desta pessoa, tirada do que ela realmente escreveu"}`;
